...
/*
Pre: N/A
What it does: The class Giraffe is the subclass of the animal method and it contains the methods/functions that run the program
Post: N/A
 */
public class Giraffe extends Animal {
    ...
    /*
   Pre: N/A
   What it does: This is the constructor of the Giraffe class and it gives an initial value to the variable members
   Post: N/A
    */
    public Giraffe() {
        food = 0;
    ...
    been passed as a parameter to the Giraffe class.
    Post: N/A
     */
    public Giraffe(int initialFood, int initialWater, int initialWarmth, int initialHealth, int initialLifelines) {
        food = initialFood;
        water = initialWater;
    ...
    */
    ...
    /*
    Pre: N/A
    What it does:  The method directs and organizes the game, and all the methods in the subclass
    Post: N/A
     */
    public void Menu() {
        ...
        if (choice == 1) {
            ...
            //the user chooses to find shelter
            ...
            //choice == 5;
            //the user chooses to use a lifeline
            useLifeline();
        }
    ...
    */
    ...
    public String findFood(int choice) {
        if (choice == 1){
            ...
            int number = random.nextInt(-8, 10);
            if ((food + number) <= 15 && (food + number) >= 0){
                if (number > 0) {
                    if (number == 1){
                        //random good event
                        int remainingValue = 15 - food;
    ...
    */
    public String findWater(int choice) {
        if (choice == 2){
            Random random = new Random();
            int number = random.nextInt(-8 , 10);
            if ((water + number) <= 15 && (water + number) >= 0){
                if (number > 0) {
                    if (number == 1){
                        //random good event
                        int remainingValue = 15 - water;
    ...
    public String findWarmth(int choice) {
        if (choice == 3){
            Random random = new Random();
            int number = random.nextInt(-8, 10);
            if ((warmth + number) <= 15  && (warmth + number) >= 0){
                if (number > 0) {
                    if (number == 1){
                        //random good event
                        int remainingValue = 15 - warmth;
    ...
    public String getRest(int choice) {
        if (choice == 4){
            ...
            if ((health + number) <= 15 && (health + number) >= 0){
                if (number == 1){
                    //random good event
                    int remainingValue = 15 - health;
