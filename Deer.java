...
/*
Pre: N/A
What it does: The class Deer is the subclass of the animal method and it contains the methods/functions that run the program
Post: N/A
 */
...
public class Deer extends Animal {
    ...
    /*
   Pre: N/A
   What it does: This is the constructor of the Deer class and it gives an initial value to the variable members
   Post: N/A
    */
    public Deer() {
        food = 0;
    ...
    been passed as a parameter to the deer class.
    Post: N/A
     */
    public Deer(int initialFood, int initialWater, int initialWarmth, int initialHealth, int initialLifelines) {
        food = initialFood;
        water = initialWater;
   ...
   */
    ...
    public String findFood(int choice) {
        if (choice == 1){
            ...
            if ((food + number) <= 10 && (food + number) >= 0){
                if (number > 0) {
                    if (number == 1){
                        //random good event
                        int remainingValue = 10 - food;
   ...
   */
    public String findWater(int choice) {
        if (choice == 2){
            Random random = new Random();
            int number = random.nextInt(-10, 10);
            if ((water + number) <= 10 && (water + number) >= 0){
                if (number > 0) {
                    if (number == 1){
                        //random good event
                        int remainingValue = 10 - water;
    ...
    public String findWarmth(int choice) {
        if (choice == 3){
            Random random = new Random();
            int number = random.nextInt(-10, 10);
            if ((warmth + number) <= 10  && (warmth + number) >= 0){
                if (number > 0) {
                    if (number == 1){
                        //random good event
                        int remainingValue = 10 - warmth;
    ...
    public String getRest(int choice) {
        if (choice == 4){
            ...
            if ((health + number) <= 10 && (health + number) >= 0){
                if (number == 1){
                    //random good event
                    int remainingValue = 10 - health;
