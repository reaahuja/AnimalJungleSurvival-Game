...
/*
Pre: N/A
What it does: The class Elephant is the subclass of the animal method and it contains the methods/functions that run the program
Post: N/A
 */
public class Elephant extends Animal {
    ...
    /*
   Pre: N/A
   What it does: This is the constructor of the Elephant class and it gives an initial value to the variable members
   Post: N/A
    */
    public Elephant() {
        food = 0;
    ...
    been passed as a parameter to the Elephant class.
    Post: N/A
     */
    public Elephant(int initialFood, int initialWater, int initialWarmth, int initialHealth, int initialLifelines) {
        food = initialFood;
        water = initialWater;
    ...
    */
    ...
    public String findFood(int choice) {
        if (choice == 1){
            ...
            int number = random.nextInt(-6, 10);
            if ((food + number) <= 20 && (food + number) >= 0){
                if (number > 0) {
                    if (number == 1){
                        //random good event
                        int remainingValue = 20 - food;
    ...
    */
    public String findWater(int choice) {
        if (choice == 2){
            Random random = new Random();
            int number = random.nextInt(-6 , 10);
            if ((water + number) <= 20 && (water + number) >= 0){
                if (number > 0) {
                    if (number == 1){
                        //random good event
                        int remainingValue = 20 - water;
    ...
    public String findWarmth(int choice) {
        if (choice == 3){
            Random random = new Random();
            int number = random.nextInt(-6, 10);
            if ((warmth + number) <= 20  && (warmth + number) >= 0){
                if (number > 0) {
                    if (number == 1){
                        //random good event
                        int remainingValue = 20 - warmth;
    ...
    public String getRest(int choice) {
        if (choice == 4){
            ...
            if ((health + number) <= 20 && (health + number) >= 0){
                if (number == 1){
                    //random good event
                    int remainingValue = 20 - health;
